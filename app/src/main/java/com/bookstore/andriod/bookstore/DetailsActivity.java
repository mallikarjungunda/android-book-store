...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEdit.setText(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_NAME)));
        priceEdit.setText(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_PRICE)));
        quantityEdit.setText(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_QUANTITY)));
        supplierNameEdit.setText(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEdit.setText(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEdit.setText(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_SUPPLIER_EMAIL)));
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(StockContract.BookStoreConstants.COLUMN_IMAGE))));
    ...
    private int deleteAllRowsFromTable() {
        ...
        return database.delete(StockContract.BookStoreConstants.TABLE_NAME, null, null);
    }
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        int rowsDeleted = database.delete(
                StockContract.BookStoreConstants.TABLE_NAME, selection, selectionArgs);
        return rowsDeleted;
    }
